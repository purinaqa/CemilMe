                        ...
                        <div class="single_abouts_text wow slideInRight" data-wow-duration="1s">
                            <div class="card card-outline-secondary my-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <small class="text-muted">Posted by Anonymous on 3/1/17</small>
                                    <hr>
                                    <a class="btn btn-primary" data-toggle="modal" data-target="#emailModal">Leave a Review</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form role="form">
                            <div class="form-group">
                                <label for="comment"><span class="glyphicon glyphicon-user"></span>Insert your email</label>
                                <input type="text" class="form-control" id="comment" width="200px" height="200px" placeholder="email">
                            </div>
                            <button type="submit" class="btn btn-block" data-dismiss="modal" data-toggle="modal" href="#commentModal">Give Feedback 
                            <span class="glyphicon glyphicon-ok"></span>
                            </button>
                        </form>
                    </div>
                    ...
                    <div class="modal-body">
                        <form role="form">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="comment" rows="5" placeholder="type your comment here..">
                            </div>
